		...
		stage ('QA') {
			...
			steps {
				script {
					...
					prospector -0 --uses celery --uses flask -s veryhigh --max-line-length 200 -m -w bandit -w frosted -w pyflakes -w pylint -w pyroma -w vulture -W pep257 -o pylint:prospector.txt -i tsa/settings.py -i tsa/celeryconfig.py -i tsa/cache.py
					'''
