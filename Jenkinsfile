pipeline {
	...
	stages {
		...
		stage('Deploy') {
			...
			steps {
				script {
					sh 'cd /home/alex/NKOD-TS; docker-compose down; docker-compose pull; redis-cli -h 10.114.0.2 -n 0 flushdb; redis-cli -h 10.114.0.2 -n 1 flushdb; docker-compose up -d --remove-orphans'
					sh 'sleep 20'
