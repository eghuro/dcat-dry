...
RUN apt-get install -y g++ gcc libffi-dev libssl-dev make && python -m pip install --upgrade pip && pip install -r requirements.txt && apt-get purge g++ gcc libffi-dev libssl-dev make
