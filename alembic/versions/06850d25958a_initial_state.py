...
def upgrade() -> None:
    ...
    op.create_index('dataset_distribution_index_ds', 'dataset_distribution', ['ds'], postgresql_using='HASH')
    op.create_index('dataset_distribution_index_distr', 'dataset_distribution', ['distr'], postgresql_using='HASH')
